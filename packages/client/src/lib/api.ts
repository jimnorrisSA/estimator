...
export const api = {
  jira: {
    ...
    syncedFeatures: (projectId: string) =>
      apiFetch(`/api/projects/${projectId}/jira/sync/features`),
    resetMappings: (projectId: string) =>
      apiFetch(`/api/projects/${projectId}/jira/sync/mappings`, { method: "DELETE" }),
