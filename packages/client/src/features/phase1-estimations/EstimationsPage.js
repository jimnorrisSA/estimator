...
export function EstimationsPage() {
    ...
    return (_jsxs("div", { className: "flex flex-col h-full w-full overflow-hidden", children: [_jsxs("div", { className: "flex flex-1 min-h-0 overflow-hidden", children: [_jsx(EstimationList, {}), _jsx(EstimationCanvas, {})] }), hasTasks && (_jsx("div", { className: "flex-shrink-0 border-t border-[#2e2848] bg-[#14112a]", children: _jsxs("button", { className: "w-full flex items-center gap-2 px-5 py-2 text-xs font-semibold text-[#5c5575] hover:text-[#9b93ba] transition-colors uppercase tracking-wide", onClick: () => setSpecsOpen((v) => !v), children: [_jsx("span", { className: "transition-transform", style: { display: "inline-block", transform: specsOpen ? "rotate(90deg)" : "rotate(0deg)" }, children: "\u25B6" }), "Task Specifications", _jsxs("span", { className: "ml-auto text-[#3a3456] font-normal normal-case tracking-normal", children: [result.tasks.length, " task", result.tasks.length !== 1 ? "s" : ""] })] }) })), hasTasks && specsOpen && (_jsx("div", { className: "flex-shrink-0 h-72 border-t border-[#2e2848] overflow-y-auto bg-[#0d0b16]", children: _jsx(SpecsTable, { tasks: result.tasks, features: features, settings: settings, currencySymbol: symbol }) }))] }));
}
