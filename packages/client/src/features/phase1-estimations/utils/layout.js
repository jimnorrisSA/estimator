...
export function groupHeight(taskCount) {
    return GROUP_HEADER_H + taskCount * TASK_ROW_H + ADD_TASK_H + GROUP_BOTTOM_PAD;
}
export function featureHeight(groups) {
    if (groups.length === 0) {
...
export function computeGroupLayouts(feature) {
...
export function addGroupButtonY(feature) {
