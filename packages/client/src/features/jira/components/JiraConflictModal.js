...
export function JiraConflictModal({ projectId, conflicts, onClose, onResolved }) {
    ...
    return (_jsx("div", { className: "fixed inset-0 z-[2000] flex items-center justify-center bg-black/60 backdrop-blur-sm", onMouseDown: (e) => { if (e.target === e.currentTarget)
            onClose(); }, children: _jsxs("div", { className: "bg-[#1a1628] border border-[#2e2848] rounded-xl shadow-xl p-6 w-[620px] max-h-[80vh] flex flex-col gap-4", children: [_jsxs("div", { className: "flex items-center justify-between flex-shrink-0", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-base font-semibold text-[#ece7ff]", children: "Resolve sync conflicts" }), _jsxs("p", { className: "text-xs text-[#5c5575] mt-0.5", children: [conflicts.length, " conflict", conflicts.length !== 1 ? "s" : "", " \u2014 choose which version to keep"] })] }), _jsx("button", { onClick: onClose, className: "text-[#3a3456] hover:text-[#9b93ba] text-xl leading-none transition-colors", children: "\u00D7" })] }), _jsx("div", { className: "flex-1 overflow-y-auto flex flex-col gap-3 min-h-0", children: conflicts.map((c) => {
                        const winner = decisions[c.mapping_id];
                        return (_jsxs("div", { className: "bg-[#14112a] border border-[#2e2848] rounded-lg p-4 flex flex-col gap-3", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "text-xs font-mono text-[#7c3aed] bg-[#2e2848] px-1.5 py-0.5 rounded", children: c.jira_issue_key }), c.field && (_jsxs("span", { className: "text-xs text-[#5c5575]", children: ["Field: ", c.field] }))] }), _jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsxs("button", { onClick: () => pick(c.mapping_id, "estimator"), className: `p-3 rounded-lg border text-left transition-all ${winner === "estimator"
                                                ? "border-[#7c3aed] bg-[#2e2848]"
                                                : "border-[#2e2848] bg-[#1d1930] hover:border-[#5b4b8a]"}`, children: [_jsx("p", { className: "text-xs font-semibold text-[#7c3aed] mb-1", children: "Estimator" }), _jsx("p", { className: "text-sm text-[#ece7ff] break-words leading-snug", children: c.estimator_value || c.estimator_label || "—" })] }), _jsxs("button", { onClick: () => pick(c.mapping_id, "jira"), className: `p-3 rounded-lg border text-left transition-all ${winner === "jira"
                                                ? "border-blue-500 bg-blue-500/10"
                                                : "border-[#2e2848] bg-[#1d1930] hover:border-[#5b4b8a]"}`, children: [_jsx("p", { className: "text-xs font-semibold text-blue-400 mb-1", children: "Jira" }), _jsx("p", { className: "text-sm text-[#ece7ff] break-words leading-snug", children: c.jira_value || c.jira_summary || "—" })] })] })] }, c.mapping_id));
