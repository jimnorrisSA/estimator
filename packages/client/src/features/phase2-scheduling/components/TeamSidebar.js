...
function MemberRow({ member, symbol, defaultMonthlyRate, onUpdate, onDelete, }) {
    ...
    return (_jsxs("div", { className: "flex items-start gap-1.5 group rounded-lg px-1.5 py-1 hover:bg-[#1d1930] transition-colors", children: [_jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-1.5", children: [_jsx("span", { className: "flex-1 text-sm text-[#ece7ff] truncate", children: member.name }), displayRate > 0 && (_jsxs("span", { className: "text-sm text-[#5c5575] tabular-nums flex-shrink-0", children: [symbol, displayRate.toLocaleString()] }))] }), _jsxs("div", { className: "flex items-center gap-1.5 mt-0.5", children: [effectiveType === "FTE" ? (_jsx("span", { className: "text-xs px-1 rounded", style: { background: "rgba(16,185,129,0.15)", color: "#6ee7b7" }, children: "FTE" })) : (_jsx("span", { className: "text-xs px-1 rounded", style: { background: "rgba(124,58,237,0.15)", color: "#a78bfa" }, children: "Contractor" })), allocLabel && _jsx("span", { className: "text-xs text-[#5c5575]", children: allocLabel }), dateHint && _jsx("span", { className: "text-xs text-[#5c5575] truncate", children: dateHint })] }), member.email && (_jsx("span", { className: "text-xs text-[#5c5575] truncate mt-0.5", children: member.email }))] }), _jsxs("div", { className: "flex gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity mt-0.5 flex-shrink-0", children: [_jsx("button", { className: "p-0.5 rounded text-[#5c5575] hover:text-[#a78bfa] hover:bg-[#252041] transition-colors", onClick: openEdit, title: "Edit", children: _jsx("svg", { className: "w-3 h-3", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", children: _jsx("path", { d: "M8 2l2 2-6 6H2V8l6-6z" }) }) }), _jsx("button", { className: "p-0.5 rounded text-[#5c5575] hover:text-red-400 hover:bg-red-900/20 transition-colors", onClick: () => onDelete(member.id), title: "Remove", children: _jsx("svg", { className: "w-3 h-3", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", children: _jsx("path", { d: "M2 2l8 8M10 2l-8 8" }) }) })] })] }));
}
// ─── Cost footer ──────────────────────────────────────────────────────────────
