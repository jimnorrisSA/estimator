...
function ProjectCard({ children }) {
    return (_jsxs(motion.div, { className: "group flex flex-col rounded-2xl border border-[#2e2848] bg-[#14112a] overflow-hidden", whileHover: { y: -3, boxShadow: "0 8px 30px rgba(124,58,237,0.2)", borderColor: "rgba(124,58,237,0.5)" }, transition: { duration: 0.2, ease: [0.23, 1, 0.32, 1] }, children: [_jsx("div", { className: "h-1.5 w-full", style: { background: "linear-gradient(90deg, #7c3aed, #5b21b6)" } }), _jsx("div", { className: "flex flex-col gap-3 p-5 flex-1", children: children })] }));
}
