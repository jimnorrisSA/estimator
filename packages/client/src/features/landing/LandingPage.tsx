  ...
  return (
    <div className="relative w-full h-full overflow-hidden" style={{ background: "#080612" }}>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% -10%, rgba(109,40,217,0.35) 0%, transparent 70%), radial-gradient(ellipse 50% 40% at 80% 80%, rgba(59,7,100,0.25) 0%, transparent 70%)",
        }}
      />
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <h1
              ...
              style={{ textShadow: "0 0 60px rgba(139,92,246,0.6), 0 2px 4px rgba(0,0,0,0.8)" }}
            >
              VIGO
            </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <button
              ...
              style={{
                ...
                boxShadow: "0 0 32px rgba(124,58,237,0.5), 0 4px 16px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.1)",
                minWidth: 220,
              }}
            >
            ...
            >
              <span className="flex items-center justify-center gap-2">
                ...
                {projects.length > 0 && (
                  <span className="text-xs bg-[#7c3aed] text-white rounded-full px-2 py-0.5 ml-1">
                    {projects.length}
                  </span>
                )}
              </span>
          ...
          >
            ...
            <div className="flex gap-3 pt-1">
              ...
              <button
                ...
                className="px-8 py-2.5 rounded-xl text-sm font-semibold text-[#5c5575] hover:text-[#9b93ba] transition-colors"
