...
function resourceCostFromAllocations(r, defaultRate) {
...
function FinancialOverview({ totalMM, totalMMExcluded, atCost, revenueGBP, profit, margin, usdRate, missingRates, onRevenueChange, onUsdRateChange, }) {
    ...
    return (_jsxs("div", { className: "rounded-2xl border border-[#2e2848] overflow-hidden", children: [_jsx("div", { className: "px-6 py-4 bg-[#14112a] border-b border-[#2e2848]", children: _jsx("h2", { className: "text-sm font-bold uppercase tracking-widest text-[#9b93ba]", children: "Financial Overview" }) }), missingRates.length > 0 && (_jsxs("div", { className: "px-6 py-2.5 flex items-center gap-2 bg-amber-950/30 border-b border-amber-900/40", children: [_jsx("span", { className: "text-amber-400 text-xs", children: "\u26A0" }), _jsxs("span", { className: "text-xs text-amber-400", children: ["No rate set for: ", missingRates.join(", "), " \u2014 counted as \u00A30."] })] })), _jsxs("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-px bg-[#2e2848]", children: [_jsxs("div", { className: "bg-[#0d0b16] px-6 py-5 flex flex-col gap-1", children: [_jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-[#5c5575]", children: "Total MM" }), _jsx("span", { className: "text-xs text-[#5c5575]", children: "Man-months of work" }), _jsxs("span", { className: "text-2xl font-bold text-[#9b93ba] tabular-nums mt-2", children: [totalMM.toFixed(1), _jsx("span", { className: "text-base font-normal text-[#5c5575] ml-1", children: "MM" })] }), totalMMExcluded > 0 && _jsxs("span", { className: "text-xs text-amber-400", children: ["+", totalMMExcluded, " excluded"] })] }), _jsxs("div", { className: "bg-[#0d0b16] px-6 py-5 flex flex-col gap-1", children: [_jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-[#5c5575]", children: "At Cost" }), _jsx("span", { className: "text-xs text-[#5c5575]", children: "Total delivery cost" }), _jsx("span", { className: "text-2xl font-bold tabular-nums mt-2", style: { color: "#a78bfa" }, children: fmtGBP(atCost) }), _jsx("span", { className: "text-xs text-[#5c5575] tabular-nums", children: fmtUSD(atCost, usdRate) })] }), _jsxs("div", { className: "bg-[#0d0b16] px-6 py-5 flex flex-col gap-1", children: [_jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-[#5c5575]", children: "Revenue" }), _jsx("span", { className: "text-xs text-[#5c5575]", children: "Client contract (USD)" }), _jsxs("div", { className: "flex items-baseline gap-1 mt-2", children: [_jsx("span", { className: "text-sm text-[#5c5575]", children: "$" }), _jsx("input", { type: "number", min: 0, step: 1000, placeholder: "0", className: "flex-1 min-w-0 text-2xl font-bold bg-transparent border-b border-[#2e2848] focus:border-[#7c3aed] text-[#ece7ff] outline-none pb-0.5 tabular-nums placeholder:text-[#3a3456] w-full", value: revDraft, onChange: (e) => setRevDraft(e.target.value), onBlur: commitRevenue, onKeyDown: (e) => { if (e.key === "Enter")
                                            e.currentTarget.blur(); } })] }), revenueGBP > 0 && (_jsxs("span", { className: "text-xs text-[#5c5575] tabular-nums", children: ["\u2248 ", fmtGBP(revenueGBP)] }))] }), _jsxs("div", { className: "bg-[#0d0b16] px-6 py-5 flex flex-col gap-1", children: [_jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-[#5c5575]", children: "Profit" }), _jsx("span", { className: "text-xs text-[#5c5575]", children: "Revenue \u2212 Cost \u2212 Agency Fee" }), profit !== null ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "text-2xl font-bold tabular-nums mt-2", style: { color: profitColor }, children: fmtGBP(profit) }), _jsx("span", { className: "text-xs text-[#5c5575] tabular-nums", children: fmtUSD(profit, usdRate) })] })) : (_jsx("span", { className: "text-2xl font-bold text-[#5c5575] mt-2", children: "\u2014" }))] }), _jsxs("div", { className: "bg-[#0d0b16] px-6 py-5 flex flex-col gap-1", children: [_jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-[#5c5575]", children: "Margin" }), _jsx("span", { className: "text-xs text-[#5c5575]", children: "Profit \u00F7 Revenue" }), _jsx("span", { className: "text-2xl font-bold tabular-nums mt-2", style: { color: marginColor }, children: margin !== null ? `${Math.round(margin)}%` : "—" })] })] }), _jsxs("div", { className: "px-6 py-3 bg-[#0d0b16] border-t border-[#2e2848] flex flex-wrap items-center gap-3", children: [_jsx("span", { className: "text-xs text-[#5c5575]", children: "Exchange rate:" }), _jsx("span", { className: "text-xs text-[#9b93ba]", children: "1 GBP =" }), _jsx("input", { type: "number", min: 0.01, step: 0.01, className: "border border-[#2e2848] bg-[#1a1628] text-[#ece7ff] rounded px-2 py-1 text-xs w-20 focus:outline-none focus:ring-1 focus:ring-[#7c3aed]", value: rateDraft, onChange: (e) => setRateDraft(e.target.value), onBlur: commitRate, onKeyDown: (e) => { if (e.key === "Enter")
