...
function MilestoneStrip({ milestones, settings, onAdd, onUpdate, onDelete, focusedMilestoneId, onFocusMilestone }) {
...
function MilestoneRow({ milestone: m, zebra, focused, onUpdate, onDelete, onFocus }) {
    ...
    return (_jsxs("tr", { className: `${rowBg} border-t transition-colors group cursor-pointer`, style: { borderColor: focused ? m.color : "#2e2848", borderLeftWidth: focused ? 3 : undefined, borderLeftColor: focused ? m.color : undefined }, onClick: onFocus, title: focused ? "Click to exit focus" : "Click to zoom into this milestone", children: [_jsx("td", { className: "px-4 py-2.5", children: _jsxs("div", { className: "flex items-center gap-2.5", children: [_jsx("input", { type: "color", value: m.color, onChange: (e) => onUpdate(m.id, { color: e.target.value }), className: "w-4 h-4 rounded-sm border-0 cursor-pointer flex-shrink-0 bg-transparent", title: "Change colour" }), editingTitle ? (_jsx("input", { autoFocus: true, className: "bg-transparent border-b border-[#7c3aed] text-[#ece7ff] text-sm outline-none w-40 caret-[#a78bfa]", value: m.title, onChange: (e) => onUpdate(m.id, { title: e.target.value }), onBlur: () => setEditingTitle(false), onKeyDown: (e) => { if (e.key === "Enter" || e.key === "Escape")
                                setEditingTitle(false); } })) : (_jsx("span", { className: "text-[#ece7ff] font-medium cursor-pointer hover:text-[#a78bfa] transition-colors", onDoubleClick: () => setEditingTitle(true), title: "Double-click to rename", children: m.title }))] }) }), _jsx("td", { className: "px-4 py-2.5", onClick: (e) => e.stopPropagation(), children: _jsx("input", { type: "date", className: "bg-transparent text-[#9b93ba] text-xs focus:outline-none focus:text-[#ece7ff] cursor-pointer", value: m.startDate, onChange: (e) => onUpdate(m.id, { startDate: e.target.value }) }) }), _jsx("td", { className: "px-4 py-2.5", onClick: (e) => e.stopPropagation(), children: _jsx("input", { type: "date", className: "bg-transparent text-[#9b93ba] text-xs focus:outline-none focus:text-[#ece7ff] cursor-pointer", value: m.endDate, onChange: (e) => onUpdate(m.id, { endDate: e.target.value }) }) }), _jsx("td", { className: "px-4 py-2.5 text-center", onClick: (e) => e.stopPropagation(), children: _jsxs("div", { className: "flex items-center justify-center gap-1", children: [_jsx("input", { type: "number", min: 0, step: 1, className: "w-12 text-center bg-[#1d1930] border border-[#2e2848] text-[#ece7ff] text-xs rounded px-1 py-0.5 focus:outline-none focus:ring-1 focus:ring-[#7c3aed]", value: m.hardeningDays ?? 0, onChange: (e) => onUpdate(m.id, { hardeningDays: Math.max(0, parseInt(e.target.value) || 0) }) }), _jsx("span", { className: "text-xs text-[#5c5575]", children: "d" })] }) }), _jsx("td", { className: "px-4 py-2.5 text-center", onClick: (e) => e.stopPropagation(), children: _jsx("div", { className: "flex items-center justify-center gap-0.5", children: [undefined, 2, 3].map((v) => (_jsx("button", { className: `px-2 py-0.5 text-xs rounded transition-colors ${m.sprintLengthWeeks === v
                            ? "bg-[#7c3aed] text-white font-semibold"
                            : "bg-[#1d1930] text-[#5c5575] hover:text-[#9b93ba]"}`, onClick: (e) => { e.stopPropagation(); onUpdate(m.id, { sprintLengthWeeks: v }); }, children: v == null ? "—" : `${v}w` }, String(v)))) }) }), _jsx("td", { className: "px-4 py-2.5 text-center", onClick: (e) => e.stopPropagation(), children: _jsx("button", { className: "opacity-0 group-hover:opacity-100 text-[#3a3456] hover:text-red-400 transition-all text-lg leading-none", onClick: () => onDelete(m.id), title: "Delete milestone", children: "\u00D7" }) })] }));
}
